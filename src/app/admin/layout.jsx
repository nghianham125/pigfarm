              ...
              <Menu
                ...
                items={[
                    ...
                    children: [
                      {
                        key: "4",
                        label: (
                          <Link href="/admin/type-animal">Loại vật nuôi</Link>
                        ),
                      },
                      {
                        key: "5",
                    ...
                    children: [
                      {
                        key: "13",
                        label: (
                          <Link href="/admin/type-feed">
                            Quản lí loại thức ăn
                          </Link>
                        ),
                      },
                      {
                    ...
                    children: [
                      {
                        key: "19",
                        label: (
                          <Link href="/admin/acpigintakes">Phiếu nhập heo</Link>
                        ),
                      },
                      {
                        key: "20",
                        label: (
                          <Link href="/admin/acfeedintakes">
                            Phiếu nhập thức ăn
                          </Link>
                        ),
                      },
                  ...
                  },
                  {
                    ...
                    icon: <HomeOutlined />,
                    label: (
                      <Link href="/admin/supplier">Quản lí nhà cung cấp</Link>
                    ),
                  },
                ]}
              />
                ...
                <Row>
                  <Col md={18}>
                    <div className="d_nav">
                      ...
                      />
                      <Search
                        placeholder="Tìm kiếm gì đó không biết nữa"
                        onSearch={onSearch}
                        enterButton
                      />
                    </div>
                  ...
                  <Col md={6}>
                    <div className="d_avatar">
                      ...
                      <span className="d_username">{username}</span>{" "}
